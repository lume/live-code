...
let OutputView = (() => {
    ...
    var OutputView = class extends _classSuper {
        ...
        mode = (__runInitializers(this, _value_extraInitializers), __runInitializers(this, _mode_initializers, 'html>iframe'));
        #iframe = __runInitializers(this, _mode_extraInitializers);
        connectedCallback() {
